...
namespace React
{
	...
	public interface IReactSiteConfiguration
	{
		...
		/// <summary>
		/// The asset manifest generated by webpack
		/// </summary>
		string ReactAppBuildPath { get; set; }

		/// <summary>
		/// Sets the asset manifest generated by webpack
		/// </summary>
		/// <param name="assetManifestPath"></param>
		/// <returns></returns>
		IReactSiteConfiguration SetReactAppBuildPath(string assetManifestPath);
	}
}
